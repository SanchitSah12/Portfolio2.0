            ...
            <ol className="items-center sm:flex">
                <li className="relative mb-6 sm:mb-0">
                    ...
                    <div className="mt-3 sm:pe-8">
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Class 12th</h3>
                        <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">2020</time>
                        <p className="text-base font-normal text-gray-500 dark:text-gray-400">Completed my schooling with a good score of 92%.</p>
                    </div>
                </li>
                <li className="relative mb-6 sm:mb-0">
                    <div className="flex items-center">
